...
(function(e, t) {
  ...
  typeof exports != t + "" ? n = exports : (r = e.L, n = {}, n.noConflict = function() {
    ...
    var i = e.requestAnimationFrame || t("RequestAnimationFrame") || r,
      s = e.cancelAnimationFrame || t("CancelAnimationFrame") || t("CancelRequestAnimationFrame") ||
    function(t) {
      e.clearTimeout(t)
    };
  ...
  n.Mixin = {}, n.Mixin.Events = {
    ...
    invalidateSize: function() {
      ...
      var t = e.subtract(this.getSize()).divideBy(2, !0);
      return this._rawPanBy(t), this.fire("move"), clearTimeout(this._sizeTimer), this._sizeTimer = setTimeout(n.Util.bind(this.fire, this, "moveend"), 200), this
    },
    ...
    initialize: function(t, r) {
      r = n.Util.setOptions(this, r), r.detectRetina && e.devicePixelRatio > 1 && r.maxZoom > 0 && (r.tileSize = Math.floor(r.tileSize / 2), r.zoomOffset++, r.minZoom > 0 && r.minZoom--, this.options.maxZoom--), this._url = t;
      var i = this.options.subdomains;
      typeof i == "string" && (this.options.subdomains = i.split(""))
    },
    onAdd: function(e) {
    ...
    _addTile: function(e, t) {
      var r = this._getTilePos(e),
        i = this._getTile();
      n.DomUtil.setPosition(i, r, n.Browser.chrome), this._tiles[e.x + ":" + e.y] = i, this._loadTile(i, e), i.parentNode !== this._container && t.appendChild(i)
    },
    ...
    initialize: function(t, r) {
      this._url = t;
      var i = n.Util.extend({}, this.defaultWmsParams);
      r.detectRetina && e.devicePixelRatio > 1 ? i.width = i.height = this.options.tileSize * 2 : i.width = i.height = this.options.tileSize;
      for (var s in r) this.options.hasOwnProperty(s) || (i[s] = r[s]);
      this.wmsParams = i, n.Util.setOptions(this, r)
    },
    onAdd: function(e) {
    ...
    _initIcon: function() {
      var e = this.options,
        ...
        s = !1;
      this._icon || (this._icon = e.icon.createIcon(), e.title && (this._icon.title = e.title), this._initInteraction(), s = !0, n.DomUtil.addClass(this._icon, i)), this._shadow || (this._shadow = e.icon.createShadow(), this._shadow && (n.DomUtil.addClass(this._shadow, i), s = !0)), s && this._updateOpacity();
    ...
    removeLayer: function(e) {
      return e.off("click dblclick mouseover mouseout mousemove contextmenu", this._propagateEvent, this), n.LayerGroup.prototype.removeLayer.call(this, e), this.invoke("unbindPopup")
    },
    ...
    _updatePathViewport: function() {
      var e = n.Path.CLIP_PADDING,
        ...
        i = r.multiplyBy(-1)._subtract(t.multiplyBy(e)),
        s = i.add(t.multiplyBy(1 + e * 2));
    ...
    addData: function(e) {
      ...
      var u = n.GeoJSON.geometryToLayer(e, s.pointToLayer);
      return o && (typeof o == "function" && (o = o(e)), u.setStyle && u.setStyle(o)), s.onEachFeature && s.onEachFeature(e, u), this.addLayer(u)
    }
    ...
    _onDown: function(e) {
      ...
      n.Browser.touch || (n.DomUtil.disableTextSelection(), this._setMovingCursor()), this._startPos = this._newPos = n.DomUtil.getPosition(this._element), this._startPoint = new n.Point(t.clientX, t.clientY), n.DomEvent.on(document, n.Draggable.MOVE, this._onMove, this), n.DomEvent.on(document, n.Draggable.END, this._onUp, this)
    },
    _onMove: function(e) {
      ...
      if (!i.x && !i.y) return;
      n.DomEvent.preventDefault(e), this._moved || (this.fire("dragstart"), this._moved = !0), this._newPos = this._startPos.add(i), this._moving = !0, n.Util.cancelAnimFrame(this._animRequest), this._animRequest = n.Util.requestAnimFrame(this._updatePosition, this, !0, this._dragStartTarget)
    },
    _updatePosition: function() {
    ...
    _performZoom: function() {
      ...
      if (!t) return;
      var r = n + t,
        i = this._getCenterForScrollWheelZoom(this._lastMousePos, r);
      e.setView(i, r)
    },
    _getCenterForScrollWheelZoom: function(e, t) {
      var n = this._map,
        r = n.getZoomScale(t),
        i = n.getSize().divideBy(2),
        s = e.subtract(i).multiplyBy(1 - 1 / r),
        o = n._getTopLeftPoint().add(i).add(s);
    ...
    _update: function() {
      var e = this._map.getBounds(),
        t = e.getCenter().lat,
        r = (new n.LatLng(t, 0)).distanceTo(new n.LatLng(t, 180)),
        i = r * (e.getNorthEast().lng - e.getSouthWest().lng) / 180,
        s = this._map.getSize(),
        o = this.options,
        u = 0;
      s.x > 0 && (u = i * (o.maxWidth / s.x)), this._updateScales(o, u)
    },
    ...
    _addItem: function(e, t) {
      ...
      e.overlay || (i.name = "leaflet-base-layers"), i.type = e.overlay ? "checkbox" : "radio", i.layerId = n.Util.stamp(e.layer), i.defaultChecked = this._map.hasLayer(e.layer), n.DomEvent.on(i, "click", this._onInputClick, this);
      var s = document.createTextNode(" " + e.name);
      r.appendChild(i), r.appendChild(s);
    ...
    run: function(e) {
      var t, r = [],
        i = n.Transition.CUSTOM_PROPS_PROPERTIES;
      for (t in e) e.hasOwnProperty(t) && (t = i[t] ? i[t] : t, t = this._dasherize(t), r.push(t));
      this._el.style[n.Transition.DURATION] = this.options.duration + "s", this._el.style[n.Transition.EASING] = this.options.easing, this._el.style[n.Transition.PROPERTY] = r.join(", ");
      for (t in e) e.hasOwnProperty(t) && this._setProperty(t, e[t]);
      this._inProgress = !0, this.fire("start"), n.Browser.mobileWebkit && (this.backupEventFire = setTimeout(n.Util.bind(this._onBackupFireEnd, this), this.options.duration * 1.2 * 1e3)), n.Transition.NATIVE ? (clearInterval(this._timer), this._timer = setInterval(this._onFakeStep, this.options.fakeStepInterval)) : this._onTransitionEnd()
    },
    _dasherize: function() {
      function t(e) {
    ...
    run: function(e) {
      this._props = {};
      var t = n.Transition.CUSTOM_PROPS_GETTERS,
        r = n.Transition.UNIT_RE;
      this.fire("start");
      for (var i in e) if (e.hasOwnProperty(i)) {
        var s = {};
        if (i in t) s.from = t[i](this._el);
        else {
    ...
    _step: function() {
      var e = n.Transition.getTime(),
        t = e - this._startTime,
        r = this.options.duration * 1e3;
      t < r ? this._runFrame(this._easing(t / r)) : (this._runFrame(1), this._complete())
    },
    _runFrame: function(e) {
      var t = n.Transition.CUSTOM_PROPS_SETTERS,
        r, i, s;
    ...
    _zoomToIfClose: function(e, t) {
      ...
      var r = this.getZoomScale(t),
        i = this._getCenterOffset(e).divideBy(1 - 1 / r);
      if (!this._offsetIsWithinView(i, 1)) return !1;
      n.DomUtil.addClass(this._mapPane, "leaflet-zoom-anim"), this.fire("movestart").fire("zoomstart"), this._prepareTileBg(), this.fire("zoomanim", {
        center: e,
        zoom: t
      });
      var s = this._getCenterLayerPoint().add(i);
      return this._runAnimation(e, t, r, s), !0
    },
    _runAnimation: function(t, r, i, s, o) {
      this._animatingZoom = !0, this._animateToCenter = t, this._animateToZoom = r;
      var u = n.DomUtil.TRANSFORM,
        a = this._tileBg;
      clearTimeout(this._clearTileBgTimer);
      if (n.Browser.gecko || e.opera) a.style[u] += " translate(0,0)";
      var f;
      n.Browser.android23 ? (a.style[u + "Origin"] = s.x + "px " + s.y + "px", f = "scale(" + i + ")") : f = n.DomUtil.getScaleString(i, s), n.Util.falseFn(a.offsetWidth);
      var l = {};
      o ? l[u] = a.style[u] + " " + f : l[u] = f + " " + a.style[u], a.transition.run(l)
    },
    _prepareTileBg: function() {
      var e = this._tilePane,
        t = this._tileBg;
      if (!n.Browser.android23 && t && this._getLoadedTilesPercentage(t) > .5 && this._getLoadedTilesPercentage(e) < .5) {
      ...
      r.transition || (r.transition = new n.Transition(r, {
        duration: .25,
        easing: "cubic-bezier(0.25,0.1,0.25,0.75)"
      }), r.transition.on("end", this._onZoomTransitionEnd, this)), this._stopLoadingImages(r)
    },
